...
//    Debug.Log("計算するプランは" + plan);
      ...
      switch(kyaria){
        ...
        switch(plan){
          ...
          //コミコミプランは割引なし！
          tuusin = ((aumax - (family*550) - (BB*1100) - (pay*110))/DateTime.DaysInMonth(dt.Year, ((dt.Month%12)+1))) + komi;
          ryoukin[1,1] = tuusin;
          uqhiwari = (((aumax - (family*550) - (BB*1100) - (pay*110))-komi)/DateTime.DaysInMonth(dt.Year, ((dt.Month%12)+1)));
